...
def calc_fx(K0,reorg_e,x,d,deltaX,deltaT,Theta,n,Re,d_A,d_B,d_M,d_N,z_A,z_B,z_M,z_N,aA,bA,cA,dA, aB,bB,cB,dB, aM,bM,cM,dM, aN,bN,cN,dN, aPhi,bPhi,cPhi,dPhi,fx,):
    h = deltaX
...
#@timer
@partial(jax.jit,static_argnums=7)
def calc_jacob(K0,reorg_e,x,d,deltaX,deltaT,Theta,n,Re,d_A,d_B,d_M,d_N,z_A,z_B,z_M,z_N,aA,bA,cA,dA, aB,bB,cB,dB, aM,bM,cM,dM, aN,bN,cN,dN, aPhi,bPhi,cPhi,dPhi,J):
    h = deltaX
