...
- **benchmarks.py** — Scripts for benchmarking various gradient-free methods including Bayesian Optimization, Covariance Matrix Adaptation Evolution Strategy (CMA-ES), Particle Swarm Optimization (PSO), and Nelder-Mead (NM) algorithm.
...
```bash
python solver.py --p0 -3.0 --p1 -3.0 --lbd 0.005 --save (optional)
```
